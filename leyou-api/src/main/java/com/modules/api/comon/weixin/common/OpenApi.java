package com.modules.api.comon.weixin.common;

import com.alibaba.fastjson.JSON;
import com.alibaba.fastjson.JSONObject;
import com.alibaba.fastjson.TypeReference;
import com.fasterxml.jackson.core.JsonParseException;
import com.modules.api.comon.weixin.entity.TokenConstant;
...
public abstract class OpenApi {
  ...
  public static TokenConstant token;
   ...
   * @throws IOException
   */
  public static TokenConstant getToken() throws WeixinException, IOException {
    if (token == null || token.getExpires_in() < System.currentTimeMillis()) {
      ...
      System.out.println(res.asString());
      token = JSON.parseObject(res.asString(), new TypeReference<TokenConstant>() {
      });
    }
    return token;
  }
